...
export const DashboardPage: React.FC<DashboardPageProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Tab Switcher: Casos Forenses vs Ferramentas */}
      <div className="flex flex-wrap items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-2 gap-3">
        <div className="flex items-center gap-2">
          <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold bg-sky-600 text-white shadow-xs">
            <Briefcase className="w-4 h-4" />
            <span>Casos Forenses</span>
          ...
          {onNavigateTools && (
            <button
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 shadow-xs transition group"
              id="btn-dashboard-tab-tools"
            >
              <Globe className="w-4 h-4 text-sky-500 group-hover:scale-110 transition-transform" />
              <span>Ferramentas & Plataformas</span>
              <span className="hidden sm:inline text-[10px] text-sky-600 dark:text-sky-400 font-semibold bg-sky-50 dark:bg-sky-950/60 px-1.5 py-0.5 rounded border border-sky-200/50 dark:border-sky-800/50">
                Acessar Links
              </span>
            </button>
          )}
        ...
        {onNavigateTools && (
          <button
            type="button"
            onClick={onNavigateTools}
            className="text-xs text-slate-500 hover:text-sky-600 dark:text-slate-400 dark:hover:text-sky-400 flex items-center gap-1 font-medium transition"
          >
            <span>Consultar plataformas de pesquisa (Jusbrasil, etc.)</span>
